...
Motion::Project::App.setup do |app|
  ...
  app.name = 'Grid'
  app.identifier = 'com.your_domain_here.grid'
  ...
  app.development do
    app.codesign_certificate = "iPhone Developer: David Oshiro"
    app.provisioning_profile = "signing/grid.mobileprovision"
  end

  app.release do
    app.entitlements['get-task-allow'] = false
    app.codesign_certificate = 'iPhone Distribution: David Oshiro'
    app.provisioning_profile = "signing/grid.mobileprovision"
